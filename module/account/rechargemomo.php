	...
	<div class="center-block" style="width:80%">
		<div class="form-group">
			<div id="msg_err_login" class="alert alert-danger">
				...
				<div> <font color="#0c5460">- Lưu ý: <b><font color="#008800"> Chuyển khoản ATM </font>  hoặc <font color="#CC0099"> MOMO</font></b> có thể bị trễ 10 -> 15 phút mong mọi người thông cảm. <a target="_blank" href="<?=$_config['Contact']['FB']?>">(Liên hệ Fanpage để biết thêm chi tiết)</a></font></div>
				<div>
				</div>
			</div>
		</div>
		<div class="form-group">
			<div id="msg_err_login" class="alert alert-danger">
				<div>
					...
					<br>
					<font color="#4c9900"> Lưu ý : Khi <u>Chuyển Tiền</u> xong các bạn vui lòng chụp lại biên lai và đợi 5-10p hệ thống sẽ tự động cộng coins (Nếu thấy lâu inbox Zalo ADMIN ngay để check và cộng Coins nhanh nhất) </font>
					</br>
					<font color="#0c5460">- <font color="#4c9900">MOMO:</font> Chủ tài khoản: <font color="#CC0099"><?php echo $_config['MOMO']['Name'];?></font>
					<br>- STK: <font color="#CC0099"><?php echo $_config['MOMO']['SDT'];?></font> </font>
					</br>
					<font color="#0c5460">- <font color="#4c9900">ATM: Ngân hàng Techcombank</font> Chủ tài khoản: <font color="#CC0099"><?php echo $_config['MOMO']['Name'];?></font>
