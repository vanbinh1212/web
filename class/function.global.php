...
function loadallserverforLauncher() {

	global $conn;

	$qCheck = sqlsrv_query($conn, "select * from Server_List where IsActive = 1 order by ServerID DESC", array(), array( "Scrollable" => SQLSRV_CURSOR_KEYSET));
