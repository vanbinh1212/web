...
if($Demo1 != 0)
{
	if($username != 'khanhlam') //Trong dấu '' là tên tài khoản, không được in hoa hay có kí tự hay khoảng trống
	{ 
		die('Bảo trì máy chủ.');
	}	
}
...
<head>
	...
	/*function adBlockDetected() {
		canMove = true;
		window.location = 'http://gunkyucga.top/adblock.html';
	}
...
<div class="play-sidebar">
    <div class="relative">
        ...
        <div class="sidebar-content" style="padding-top:0px">
            <div class="play-logo"><a href="http://gunkyucga.top" target="_blank"><img src="images/play-logo.png" /></a></div>
            ...
            <ul class="play-buttons">
				...
				<li>
                    <a href="<?=$_config['page']['fullurl']?>/Launcher.rar" class="play-normal-btn" target="_blank">Tải Launcher</a>
                </li>
            ...
            <tr>
                <td>
                    <div class="fcontent frame" id="flashcontent">
                        ...
                        <script>
                            var swfPath = "http://play.gn257.net/media/flash/Loading.swf";
                            var flashvars = {
                                user: "<?=$username?>",
                                key: "<?=$keyrand?>",
                                v: "104",
                                rand: "92386938",
                                config: "http://gunkyucga.top/play/vinh.xml"
                            };
                            var params = {
                                menu: "false",
                                scale: "noScale",
